...
author: "Peng Zhang · Associate Director, Innovative Data Sciences · CIMS Global"
date: 2026-06-16
    ...
    include-in-header:
      - text: |
          <style>
            ...
            .title-logo-left  { left: 56px; }
            .title-logo-right { right: 56px; }
          </style>
    include-before-body:
      - text: |
...
## Presented in two sessions {.bigtext}
